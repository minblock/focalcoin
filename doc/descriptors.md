# Support for Output Descriptors in Focalcoin Core

Since Focalcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Focalcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Focalcoin Core wallets, a convenience function `combo` is

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " focalcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  focalcoin-tx [options] <hex-tx> [commands]  Update hex-encoded focalcoin transaction\n" +
            "or:     focalcoin-tx [options] -create [commands]   Create hex-encoded focalcoin transaction\n" +
            "\n";

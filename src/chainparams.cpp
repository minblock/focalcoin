...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting turtletiposhis";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585985731, 165785, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x39d1c24a408ed6d1cdb0e948fbd5e6d531b6d898cb50019047c7b1392252cc84"));
        assert(genesis.hashMerkleRoot == uint256S("0xbc2647969899070bf403c641522c777a1eb5c615b3bbfc128befbe28de9d793b"));
        ...
        vSeeds.emplace_back("seed-a.focalcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.focalcointools.com");
        vSeeds.emplace_back("dnsseed.focalcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 2101349, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7feea813689111d8a794cb9249abff20f467ca9affe2ff7edb2bb4770969d6c5"));
        assert(genesis.hashMerkleRoot == uint256S("0xbc2647969899070bf403c641522c777a1eb5c615b3bbfc128befbe28de9d793b"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.focalcointools.com");
        vSeeds.emplace_back("seed-b.focalcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0c5066c772b88c8f3bc01e0638c33277100cc1af9a243deda83b6d07d6afee98"));
        assert(genesis.hashMerkleRoot == uint256S("0xbc2647969899070bf403c641522c777a1eb5c615b3bbfc128befbe28de9d793b"));

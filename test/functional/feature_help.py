...
"""Verify that starting focalcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start focalcoin with -h for help text")
        ...
        self.log.info("Start focalcoin with -version for version information")
        ...
        self.log.info("Start focalcoind with -fakearg to make sure it does not start")
